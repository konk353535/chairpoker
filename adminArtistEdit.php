    ...
    <div class="mainContent bgPrimary">
		...
		?>
			<form id='editArtistForm' method='post' action='adminEditArtistProcess.php' onsubmit="return input_validate_update_artist()">
				...
				<input type='text' id='Artist_Fnames' name='Artist_Fnames' value='<?php echo $artist['Artist_Fnames'] ?>'>
				<label class='label' for='Artist_Sname'>Surname:</label>
				<input type='text' id='Artist_Sname' name='Artist_Sname' value='<?php echo $artist['Artist_Sname'] ?>'>
				<label class='label' for='Artist_Email'>Email:</label>
				<input type='text' id='Artist_Email' name='Artist_Email' value='<?php echo $artist['Artist_Email'] ?>'>
				<label class='label' for='Artist_PhoneDay'>Daytime Phone:</label>
				<input type='text' id='Artist_PhoneDay' name='Artist_PhoneDay' value='<?php echo $artist['Artist_PhoneDay'] ?>'>
				<label class='label' for='Artist_Mobile'>Mobile Phone:</label>
				<input type='text' id='Artist_Mobile' name='Artist_Mobile' value='<?php echo $artist['Artist_Mobile'] ?>'>
				<div id='categorySelectsContainer'>
					<select id='ArtistCategory1' name='ArtistCategory1'>
						<?php 
